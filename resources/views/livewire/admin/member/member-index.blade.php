    ...
    @if(!$isFormOpen)
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                ...
                <button wire:click="create" class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-primary-700 focus:bg-primary-700 active:bg-primary-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-sm w-fit">
            ...
            <div x-data="{ showFilters: false }" class="bg-white rounded-xl shadow-sm border border-zinc-200 overflow-hidden mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-4">
                    ...
                    <div class="w-full sm:max-w-xs relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari anggota..." class="bg-zinc-100 focus:bg-white text-sm border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm block w-full pl-9 py-3 transition-colors">
                    </div>
                    ...
                    <div class="w-full lg:w-80 space-y-6">
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-zinc-200 space-y-4">
                            ...
                            <div>
                                ...
                                <select id="is_active" wire:model="is_active" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full mt-1 py-3 px-4 text-zinc-900 transition-colors">
