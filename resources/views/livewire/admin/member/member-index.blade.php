                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-zinc-600">
                        ...
                        <tbody class="divide-y divide-zinc-200">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-zinc-500">Belum ada data anggota.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="flex-1 space-y-6">
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-zinc-200 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="description" wire:model="description" rows="4" class="border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full mt-1 px-3 py-2 text-zinc-900"></textarea>
                                @error('description') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <x-label for="address" value="Alamat Lengkap" />
                                <textarea id="address" wire:model="address" rows="3" class="border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full mt-1 px-3 py-2 text-zinc-900"></textarea>
                    ...
                    <div class="w-full lg:w-80 space-y-6">
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-zinc-200 space-y-4">
                            ...
                            <div>
                                ...
                                <select id="is_active" wire:model="is_active" class="border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full mt-1 py-2 px-3 text-zinc-900">
