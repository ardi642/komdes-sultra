    ...
    <div x-data="{ showFilters: false }" class="bg-white rounded-xl shadow-sm border border-zinc-200 overflow-hidden mb-6">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-4">
            ...
            <div class="w-full sm:max-w-xs relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari isu..." class="bg-zinc-100 focus:bg-white text-sm border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm block w-full pl-9 py-3 transition-colors">
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="status" wire:model="status" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 transition-colors">
                            ...
                            <div class="space-y-4 md:col-span-2">
                                <div>
                                    ...
                                    <textarea id="description" wire:model="description" rows="3" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 transition-colors" placeholder="Jelaskan secara singkat mengenai isu ini..."></textarea>
                                    @error('description') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                                </div>
                                
                                <div>
                                    <x-label for="icon_svg" value="Icon SVG (Opsional, untuk desain spesifik)" />
                                    <textarea id="icon_svg" wire:model="icon_svg" rows="2" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 font-mono text-sm transition-colors" placeholder="<svg>...</svg>"></textarea>
