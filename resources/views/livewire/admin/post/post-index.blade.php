            ...
            <div x-data="{ showFilters: false }" class="bg-white rounded-xl shadow-sm border border-zinc-200 overflow-hidden mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-4">
                    ...
                    <div class="w-full sm:max-w-xs relative">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari tulisan..." class="bg-zinc-100 focus:bg-white text-sm border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm block w-full pl-9 py-3 transition-colors">
                    </div>
                ...
                <div x-show="showFilters" x-collapse>
                    <div class="p-4 bg-zinc-50 border-t border-zinc-200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model.live="filterType" class="w-full bg-white text-sm border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm py-3 px-4 text-zinc-900">
                        ...
                        <div>
                            ...
                            <select wire:model.live="filterCategory" class="w-full bg-white text-sm border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm py-3 px-4 text-zinc-900">
                    ...
                    <div class="w-full lg:w-80 space-y-6">
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-zinc-200 space-y-4">
                            ...
                            <div>
                                ...
                                <select id="type" wire:model.live="type" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 text-sm transition-colors">
                                    <option value="berita">Berita</option>
                                    <option value="artikel">Artikel</option>
                                    <option value="riset">Publikasi Riset</option>
                                    <option value="siaran_pers">Siaran Pers</option>
                            ...
                            @if($type === 'berita')
                                <div>
                                    ...
                                    <select id="category_id" wire:model="category_id" class="bg-zinc-100 focus:bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 text-sm transition-colors">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="bulkSelectedCategory" class="bg-white border-zinc-300 focus:border-primary-500 focus:ring-primary-500 rounded-lg shadow-sm w-full py-3 px-4 text-zinc-900 text-sm">
