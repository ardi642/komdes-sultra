    ...
    <form wire:submit.prevent="save" class="space-y-8">
        ...
        <div class="p-6 bg-white border border-zinc-200 rounded-2xl shadow-sm">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea wire:model="about_description" rows="5" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Masukkan deskripsi tentang Komdes Sultra..."></textarea>
                ...
                <div>
                    ...
                    <select wire:model.live="about_media_type" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors">
                ...
                <div>
                    ...
                    <textarea wire:model="about_youtube_url" rows="3" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="https://www.youtube.com/watch?v=... atau <iframe src=..."></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="p-4 bg-zinc-50 rounded-xl border border-zinc-200">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="text" wire:model="about_btn1_text" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-lg focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Misal: Tentang Kami (Kosongkan jika tidak ingin ditampilkan)">
                            </div>
                            <div>
                                <label class="block mb-1 text-xs font-medium text-zinc-600">Link / URL Tombol</label>
                                <input type="text" wire:model="about_btn1_url" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-lg focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Misal: /tentang-kami">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-zinc-50 rounded-xl border border-zinc-200">
                        ...
                        <div class="space-y-3">
                            <div>
                                <label class="block mb-1 text-xs font-medium text-zinc-600">Teks Tombol</label>
                                <input type="text" wire:model="about_btn2_text" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-lg focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Misal: Hubungi Kami (Kosongkan jika tidak ingin ditampilkan)">
                            </div>
                            <div>
                                <label class="block mb-1 text-xs font-medium text-zinc-600">Link / URL Tombol</label>
                                <input type="text" wire:model="about_btn2_url" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-lg focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Misal: /kontak">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="p-6 bg-white border border-zinc-200 rounded-2xl shadow-sm">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="network_subtitle" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Jejaring komunitas dan organisasi lokal...">
                ...
                <div>
                    ...
                    <input type="text" wire:model="issue_subtitle" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Isu strategis yang menjadi fokus...">
                ...
                <div>
                    ...
                    <input type="text" wire:model="agenda_subtitle" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Ikuti berbagai kegiatan edukasi...">
                ...
                <div>
                    ...
                    <input type="text" wire:model="publication_subtitle" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Kabar terbaru, artikel opini...">
                ...
                <div>
                    ...
                    <input type="text" wire:model="gallery_subtitle" class="w-full px-4 py-3 text-sm bg-zinc-100 border-zinc-200 rounded-xl focus:bg-white focus:ring-primary-500 focus:border-primary-500 transition-colors" placeholder="Dokumentasi aksi lapangan...">
        ...
        <div class="flex justify-end gap-4 border-t border-gray-100 pt-6 mt-8">
            ...
            <button type="button" @click="$dispatch('open-confirm-modal', {
                ...
                message: 'Apakah Anda yakin ingin menyimpan perubahan pada halaman Beranda?',
