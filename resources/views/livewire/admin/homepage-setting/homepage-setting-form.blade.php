<div>
    <div class="mb-6">
        <h2 class="text-xl font-bold text-zinc-800">Pengaturan Beranda</h2>
        <p class="text-sm text-zinc-500">Kelola konten dan tampilan halaman beranda dari sini.</p>
    </div>
    ...
    <form wire:submit.prevent="save" class="space-y-8">
        ...
        <div class="flex justify-end gap-3">
            <button type="submit" class="px-6 py-2.5 text-sm font-medium text-white transition-colors bg-primary-600 hover:bg-primary-700 rounded-xl shadow-sm">
                Simpan Pengaturan
            </button>
        </div>
    </form>
