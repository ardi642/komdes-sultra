    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
        ...
        <div class="flex items-center gap-3 relative z-10">
            ...
            <button @click="showFilter = !showFilter" 
                    class="flex items-center gap-2 text-sm font-bold px-5 py-2.5 rounded-xl transition-all shadow-sm"
                    :class="showFilter ? 'bg-primary-50 border border-primary-200 text-primary-700' : 'bg-[#165a3f] text-white hover:bg-[#114631] hover:shadow-md hover:-translate-y-0.5'">
