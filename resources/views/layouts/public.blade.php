    ...
    <footer class="bg-[#114a33] pt-16 pb-8 border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-12">
                ...
                <div class="md:col-span-5 space-y-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ $siteSetting->facebook_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
                            <span class="sr-only">Facebook</span>
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                        </a>
                        @endif
                        @if(!empty($siteSetting->instagram_url))
                        <a href="{{ $siteSetting->instagram_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
                        ...
                        <a href="{{ $siteSetting->twitter_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
                        ...
                        <a href="{{ $siteSetting->tiktok_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
                        ...
                        <a href="{{ $siteSetting->youtube_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
                        ...
                        <a href="{{ $siteSetting->linkedin_url }}" target="_blank" class="text-white/60 hover:text-white transition-colors">
            ...
            <div class="border-t border-white/10 pt-8 pb-4 flex flex-col md:flex-row justify-between items-center text-sm text-white/50">
                <p>&copy; {{ date('Y') }} {{ $siteSetting->site_name ?? 'Komdes Sultra' }}.</p>
