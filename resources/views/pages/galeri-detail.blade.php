...
<main class="w-full">
    ...
    <!-- 1. Header Section -->
    <div class="relative pt-32 pb-8 bg-white">
        <div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            
            <!-- Breadcrumb -->
            <nav class="flex text-sm text-zinc-500 mb-6 font-medium" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 text-zinc-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 md:ml-2 text-zinc-400 line-clamp-1 max-w-[200px] sm:max-w-xs">{{ $gallery->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="max-w-4xl">
                <!-- Meta data -->
                <div class="flex flex-wrap items-center gap-4 text-zinc-500 mb-4 font-medium text-sm md:text-base">
                ...
                <h1 class="font-heading text-3xl md:text-4xl lg:text-5xl font-extrabold text-zinc-900 leading-tight mb-2">
                    {{ $gallery->title }}
                </h1>
            </div>
        </div>
            ...
            @if($gallery->video_url)
                <div class="max-w-4xl mb-12 rounded-2xl overflow-hidden shadow-lg ring-1 ring-zinc-200">
                    <div class="aspect-w-16 aspect-h-9 relative w-full h-0 pb-[56.25%] bg-zinc-900">
                        <iframe 
                            src="{{ str_contains($gallery->video_url, 'watch?v=') ? str_replace('watch?v=', 'embed/', $gallery->video_url) : $gallery->video_url }}" 
