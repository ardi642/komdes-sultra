        ...
        <div class="flex-1">
            <article class="bg-white rounded-2xl p-6 md:p-10 border border-zinc-100 shadow-sm">
                ...
                <div class="mb-8">
                    ...
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-zinc-900 mb-6 leading-tight">Dialog Warga: Menyoroti Transparansi Dana Desa di Kabupaten Konawe</h1>
