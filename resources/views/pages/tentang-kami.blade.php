                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="flex items-center justify-center gap-4">
                                ...
                                <template x-if="selectedMember.email">
                                    <a :href="'mailto:' + selectedMember.email" class="w-12 h-12 rounded-2xl text-white flex items-center justify-center transition-all shadow-md hover:shadow-lg hover:-translate-y-1 focus:outline-none bg-[#165a3f]" title="Kirim Email">
                                ...
                                <template x-if="selectedMember.phone">
                                    <a :href="'tel:' + selectedMember.phone" class="w-12 h-12 rounded-2xl text-white flex items-center justify-center transition-all shadow-md hover:shadow-lg hover:-translate-y-1 focus:outline-none bg-[#165a3f]" title="Telepon">
