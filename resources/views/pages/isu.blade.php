...
<div class="relative bg-white py-24 overflow-hidden">
    ...
    <div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
            ...
            <!-- Issue Card 1 -->
            <a href="{{ route('isu.detail') }}" class="group bg-white rounded-xl p-6 border border-zinc-100 hover:border-[#165a3f] hover:shadow-2xl transition-all duration-500 flex flex-col items-center text-center h-full">
