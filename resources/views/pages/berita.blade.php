...
<div class="relative pt-64 pb-48 overflow-hidden bg-[#165a3f]">
    ...
    <div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center" data-aos="fade-up">
            ...
            <p class="text-white/90 text-base md:text-lg max-w-2xl mx-auto font-light leading-relaxed drop-shadow-sm">{{ \App\Models\SiteSetting::where('key', 'hero_news_text')->value('value') }}</p>
        </div>
    </div>
</div>
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="flex flex-wrap gap-2 mb-3" x-data="{ expanded: false }">
                            ...
                            <template x-if="expanded">
                                <!-- Using fragment or just looping directly inside template -->
                                <div class="contents">
