...
<div class="bg-primary-600 pt-32 pb-32 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            <h1 class="text-4xl md:text-5xl font-heading font-extrabold text-white mb-4 tracking-tight">Berita Terkini</h1>
            <p class="text-primary-100 text-lg max-w-2xl mx-auto">Kabar terbaru seputar advokasi, program kerja, dan dinamika komunitas desa di Sulawesi Tenggara.</p>
        </div>
    </div>
</div>
    ...
    <div class="flex flex-col lg:flex-row gap-12">
        ...
        <div class="lg:w-2/3" x-data="{ showFilter: false }">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="font-heading font-bold text-2xl text-zinc-900">Semua Berita</h2>
