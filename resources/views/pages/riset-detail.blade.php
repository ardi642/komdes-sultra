...
@section('title', 'Panduan Transparansi Dana Desa - Komdes Sultra')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('riset') }}" class="ml-1 md:ml-2 hover:text-primary-600 transition-colors">Publikasi Riset</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    <svg class="w-4 h-4 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                    <a href="{{ route('riset.kategori') }}" class="ml-1 md:ml-2 hover:text-primary-600 transition-colors">Tata Kelola Desa</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    <svg class="w-4 h-4 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                    <span class="ml-1 md:ml-2 text-zinc-700 truncate max-w-[100px] sm:max-w-[200px]">Panduan Transparan...</span>
                </div>
            </li>
        </ol>
    </nav>
            ...
            <article class="bg-white rounded-2xl p-6 md:p-10 border border-zinc-100 shadow-sm">
                ...
                <div class="mb-8">
                    <div class="mb-4 flex items-center gap-3">
                        <span class="bg-secondary-500 text-zinc-900 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">Tata Kelola Desa</span>
                    ...
                    <div class="flex items-center gap-4 text-sm">
                        <div class="flex items-center gap-3">
                            <img src="https://ui-avatars.com/api/?name=Tim+Riset&background=random" alt="Penulis" class="w-10 h-10 rounded-full shadow-sm border border-zinc-100">
                            <div class="text-left">
                                <p class="font-bold text-zinc-900">Divisi Riset</p>
                                <p class="text-xs text-zinc-500">Komdes Sultra</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-zinc-700 leading-relaxed space-y-6">
                    <p class="text-xl text-zinc-800 font-medium leading-snug">
                        Panduan ini merupakan pedoman komprehensif bagi pemerintah desa dalam menerapkan asas keterbukaan informasi pada pengelolaan Anggaran Pendapatan dan Belanja Desa (APBDes).
                    </p>
                    
                    <p>
                        Melalui penyajian prosedur, format pelaporan standar, dan metode sosialisasi yang mudah diakses warga, panduan ini diharapkan dapat meningkatkan partisipasi masyarakat serta mencegah potensi penyelewengan dana desa di Sulawesi Tenggara.
                    </p>
                    
                    <h3 class="font-heading font-bold text-2xl text-zinc-900 mt-8 mb-4">Latar Belakang</h3>
                    
                    <p>
                        Transparansi dana desa bukanlah sekadar pemasangan baliho informasi APBDes di kantor desa. Lebih dari itu, transparansi membutuhkan pemahaman warga tentang alur perencanaan, pelaksanaan, hingga pertanggungjawaban proyek yang didanai oleh APBN.
                    </p>
                    ...
                    <div class="pl-6 border-l-4 border-primary-500 my-8 py-2 bg-primary-50 rounded-r-lg">
                        <p class="text-lg italic text-zinc-800 mb-2">
                            "Kunci utama dari desa yang maju adalah kepercayaan warga terhadap pemerintahnya. Kepercayaan tersebut hanya dapat dibangun melalui transparansi anggaran."
                        </p>
                    </div>
                ...
                <div class="mt-12 pt-8 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="#" class="px-3 py-1 bg-zinc-100 text-zinc-600 text-xs rounded-lg hover:bg-primary-500 hover:text-white transition-colors">#RPJMDes</a>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-zinc-100 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="#" class="flex gap-4 group">
                            ...
                            <div>
                                <h4 class="font-bold text-zinc-900 text-sm leading-snug line-clamp-2 group-hover:text-primary-600 transition-colors mb-1">Efektivitas BUMDes dalam Pemulihan Ekonomi</h4>
                        ...
                        <div class="pt-2 border-t border-zinc-100">
                            <a href="{{ route('riset.kategori') }}" class="text-xs font-semibold text-primary-600 hover:text-primary-700 flex items-center justify-center w-full py-2 hover:bg-primary-50 rounded-lg transition-colors">
                                Lihat Publikasi Serupa Lainnya
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="{{ route('riset.kategori') }}" class="flex items-center justify-between group">
                                ...
                                <span class="bg-primary-50 text-primary-600 text-xs py-1 px-2.5 rounded-full">12</span>
                            </a>
                        </li>
                        <li>
