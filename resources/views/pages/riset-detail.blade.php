            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('riset') }}" class="ml-1 md:ml-2 hover:text-white transition-colors">Riset</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <div class="max-w-4xl">
            <div class="mb-6 flex flex-wrap items-center gap-3">
                ...
                <span class="text-sm text-white/80 flex items-center gap-1.5">
                    ...
                    {{ \Carbon\Carbon::parse($post->published_at)->locale('id')->translatedFormat('d F Y') }}
                </span>
            </div>
                        ...
                        <div class="mt-12 pt-8 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <a href="{{ route('riset', ['tags' => [$tag->slug]]) }}" class="px-3 py-1 bg-zinc-100 text-zinc-600 text-xs rounded-lg hover:bg-primary-600 hover:text-white transition-colors">#{{ $tag->name }}</a>
                                    @endforeach
                                </div>
                            </div>
